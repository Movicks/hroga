...
export default function AlumniSignupPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <HomeTopbar />
      {/* Main Signup form */}
      <div className="flex-1 flex items-center justify-center bg-primary/10 pt-20 pb-10 md:pt-30 px-4">
        <div className="max-w-2xl w-full p-8 bg-white rounded-lg shadow-lg">
          <h1 className="text-2xl font-bold text-center text-secondary">Alumni Sign Up</h1>
          <div className='w-full flex items-center mb-6'>
            <div className="mt-2 w-full">
              <button
                onClick={() => router.push('/login')}
                className="text-primary hover:underline text-center w-full text-sm font-medium"
              >
                Already have an account? Login
              </button>
            </div>
