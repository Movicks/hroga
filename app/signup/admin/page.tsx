...
import { registerAdmin, clearError } from '../../../redux/features/auth/authSlice';
...
export default function AdminSignupPage() {
  ...
  useEffect(() => {
    const savedData = localStorage.getItem('adminSignupData');
    const savedStep = localStorage.getItem('adminSignupStep');
    if (savedData) {
  ...
  useEffect(() => {
    localStorage.setItem('adminSignupData', JSON.stringify(formData));
    localStorage.setItem('adminSignupStep', currentStep.toString());
  ...
  const handleSubmit = async () => {
    ...
    if (registerAdmin.fulfilled.match(result)) {
      ...
      localStorage.removeItem('adminSignupStep');
      router.push('/admin');
    }
  };
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center bg-primary/10 py-8">
        <div className="max-w-2xl w-full p-8 bg-white rounded-lg shadow-lg">
          <h1 className="text-2xl font-bold mb-6 text-center text-secondary">Admin Registration</h1>
