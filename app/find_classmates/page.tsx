...
import { fetchUsersPublicly } from "@/redux/features/users/usersSlice";
...
import ClassmatesTable from "./components/ClassmatesTable";
import UserProfile from "./components/UserProfile";
import SearchResults from "./components/SearchResults";
import SearchBar from "./components/SearchBar";
import { getInitials, formatPlatform } from "./components/utils";
// import { useClassmatesFilter } from "./hooks/useClassmatesFilter";
import { User } from "@/redux/features/users/usersSlice";
import { useClassmatesFilter } from "@/hooks/userClassmatesbFilter";
...
export default function FindClassmatesPage() {
    ...
    const {
        ...
        handleSearchChange,
        handleClearSearch,
    } = useClassmatesFilter(users, selectedYear, selectedUser, setSelectedUser);
        ...
        <div className="min-h-[100dvh] bg-gradient-to-br from-gray-50 via-white to-blue-50/20">
            ...
            <div className="container mx-auto px-4 pt-25 md:pt-40 pb-8 max-w-6xl">
                ...
                {selectedYear && !selectedUser && (
                    <SearchBar
                        placeholder={`Search classmates from ${selectedYear}...`}
                ...
                <div>
                    ...
                    <div className="text-gray-500 mt-1 flex items-center">
                        <p className="mt-4 text-lg text-gray-600 max-w-2xl leading-relaxed">
                            Reconnect with old friends and expand your
                            professional network. Search for classmates
                            by graduation year and discover where life
                            has taken them.
                        </p>
                    </div>
                </div>
