...
export default function OgaGallery() {
  return (
    <div className="relative flex h-[22rem] md:h-[28rem] w-full items-center justify-center top-[-1rem] max-w-[350px]">
        {/* Center Circle */}
        <div className="relative lg:right-[-0.5rem] z-10 flex h-[10rem] md:h-[14rem] w-[14rem] items-center justify-center rounded-full rotate-[5deg] border-9 border-[#020D39] bg-white">
            {/* LEFT STACK */}
            <div className="absolute right-[51%] top-1/2 -translate-y-1/2 rotate-[-5deg]">
            ...
            <div className="absolute left-[47%] top-1/2 -translate-y-1/2 rotate-[-5deg]">
                <div className="flex flex-col gap-4 lg:gap-6 pt-29">
                    ...
                    <div className="h-32 w-40 md:h-45 md:w-44 rounded-md border-2 border-white bg-white overflow-hidden">
                      <Image src='/images/HROGA_Executives.jpeg' alt='OGA 1' width={100} height={100} className="w-full h-full bg-cover"/>
                    </div>
                    {/* Image 3 */}
                    <div className="h-40 w-40 md:h-54 md:w-44 rounded-md border-2 border-white bg-white overflow-hidden">
                      <Image src='/images/HROGA_Banner_Image.jpeg' alt='OGA 1' width={100} height={100} className="w-full h-full bg-cover"/>
                    </div>
                </div>
            </div>
        </div>
